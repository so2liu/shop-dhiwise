    ...
    <>
      <div className="bg-gray_50 flex flex-col font-rubik gap-[100px] sm:gap-[40px] md:gap-[40px] items-start justify-start mx-[auto] self-stretch sm:w-[100%] md:w-[100%] w-[auto]">
        ...
        <div className="flex font-poppins items-start justify-start sm:px-[20px] md:px-[40px] px-[75px] w-[100%]">
          <div className="flex md:flex-col flex-row gap-[49px] items-end justify-start max-w-[1290px] mx-[auto] w-[100%]">
            <div className="flex flex-1 flex-col gap-[42px] items-start justify-start w-[100%]">
              <div className="flex flex-row font-josefinsans gap-[50px] items-start justify-start w-[100%]">
                <div className="flex flex-col gap-[8px] items-end justify-start self-stretch w-[auto]">
                  <Text
              ...
              <Text
                className="font-normal font-rubik leading-[35.00px] not-italic text-gray_500 text-left tracking-[-0.50px]"
                variant="body2"
              >
                <>
            ...
            <div className="flex flex-1 flex-col gap-[21px] items-center justify-start w-[100%]">
        ...
        <div className="flex font-raleway items-start justify-start sm:px-[20px] md:px-[40px] px-[75px] w-[100%]">
          <div className="flex flex-col gap-[43px] items-start justify-start max-w-[1290px] mx-[auto] w-[100%]">
            <Text
